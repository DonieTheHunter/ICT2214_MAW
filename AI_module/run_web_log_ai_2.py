...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("log", help="Path to reverse-proxy log (JSON lines)")
...
def process_log_line(line: str, args: argparse.Namespace, resolved_upload_dir: str | None) -> None:
    buf = [line]
...
def main() -> None:
    ...
    line = args.log
    process_log_line(line, args, resolved_upload_dir)
